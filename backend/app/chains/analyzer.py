...
class ResumeAnalyzer:
    ...
    async def analyze(self, resume_text: str, job_description: str) -> AnalysisResponse:
        ...
        try:
            ...
            semantic_analysis_task = self._perform_semantic_analysis(
                resume_text, job_description
            )

            resume_keywords, jd_keywords, semantic_score = await asyncio.gather(
                resume_keywords_task, jd_keywords_task, semantic_analysis_task
            )
    ...
    async def _perform_semantic_analysis(
        ...
        try:
            ...
            resume_docs = [
                Document(page_content=chunk, metadata={"type": "resume"})
            ...
            if resume_docs:
                ...
                for jd_chunk in jd_chunks:
                    ...
                    if similar_docs:
                        ...
                        best_score = min(
                            [score for _, score in similar_docs]
                        )  # Lower is better in FAISS
